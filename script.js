...
(function setupPremiumProcess(){
  if (!document.getElementById("processPremiumStyles")) {
    ...
    link.rel = "stylesheet";
    link.href = "process-premium.css?v=20260909-execute-reference-v10";
  ...
  const svgIcons = [
    ...
    '<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M34 12c8-6 16-8 22-8 0 7-2 15-8 23L32 43 21 32 34 12Z"/><circle cx="41" cy="21" r="5"/><path d="M30 18 19 20 10 29l13 2"/><path d="M45 34 43 47 34 56l-2-13"/><path d="m20 35 9 9-6 6-9-9 6-6Z"/><path d="M14 44 5 53M20 49 9 60"/><path d="M48 7c0 7 3 12 9 16"/></svg>',
