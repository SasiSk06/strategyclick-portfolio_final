...
(function setWhatsAppFloatIcon(){
  ...
  whatsappFloat.innerHTML = '<svg viewBox="0 0 32 32" width="30" height="30" aria-hidden="true" focusable="false"><path fill="#fff" d="M19.11 17.37c-.27-.14-1.58-.78-1.83-.87-.24-.09-.42-.14-.6.14-.18.27-.69.87-.85 1.05-.16.18-.31.2-.58.07-.27-.14-1.14-.42-2.17-1.34-.8-.72-1.34-1.6-1.5-1.87-.16-.27-.02-.42.12-.55.12-.12.27-.31.4-.47.14-.16.18-.27.27-.45.09-.18.04-.34-.02-.47-.07-.14-.6-1.45-.82-1.98-.22-.52-.44-.45-.6-.46h-.51c-.18 0-.47.07-.71.34-.24.27-.94.92-.94 2.23 0 1.31.96 2.58 1.09 2.76.14.18 1.88 2.87 4.55 4.02.64.27 1.13.44 1.52.56.64.2 1.22.17 1.68.1.51-.08 1.58-.65 1.81-1.27.22-.62.22-1.16.15-1.27-.06-.11-.24-.18-.51-.31Z"/><path fill="#fff" d="M16.03 3.2A12.64 12.64 0 0 0 5.19 22.35L3.5 28.5l6.3-1.65a12.62 12.62 0 1 0 6.23-23.65Zm0 22.99c-1.86 0-3.68-.5-5.27-1.45l-.38-.23-3.74.98 1-3.65-.25-.38a10.39 10.39 0 1 1 8.64 4.73Z"/></svg>';
})();